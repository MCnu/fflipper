...
for csv in csvsToLink:
    ...
    linkedfile = pyelan.timeSeries(
        source=csvFile, sampleType="Continuous Rate", timeCol=0, tracks=tracks
    )
...
allTiers = pyelan.tierSet(
    media=media,
    linkedFiles=filesToLink,
    tiers=[pyelan.tier("default", [pyelan.annotation(begin=1, end=2, value="foo")])],
)
